...
class setting extends object_class{
    ...
    public function generalSetting($settingData){
        ...
        <div class="form-group">
            <label class="col-sm-4 col-md-3 control-label" ><?php echo _uc($_e['Site Name']); ?></label>
            <div class="col-sm-8 col-md-9">
                <?php
                $temp = $this->getIBMSSettingArrayValue('Site Name',$settingData);
                ?>
                <input type="text" value="<?php echo $temp; ?>" name="setting[Site Name]" id="SiteName" class="form-control">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8 col-md-9">
                <?php
                $temp = $this->getIBMSSettingArrayValue('Email',$settingData);
                ?>
                <input type="email" value="<?php echo $temp; ?>" name="setting[Email]" id="Email" class="form-control">
            </div>
        </div>


        <div class="form-group">
            <label class="col-sm-4 col-md-3 control-label" ><?php echo _uc($_e['OTC_Email']); ?></label>
            <div class="col-sm-8 col-md-9">
                <?php
                $temp = $this->getIBMSSettingArrayValue('otc_Email',$settingData);
                ?>
                <input type="email" value="<?php echo $temp; ?>" name="setting[otc_Email]" id="otc_Email" class="form-control">
            </div>
        </div>
        ...
        <div class="form-group">
            <label class="col-sm-4 col-md-3 control-label" ><?php echo _uc($_e['Contact']); ?></label>
            <div class="col-sm-8 col-md-9">
                <?php
                $temp = $this->getIBMSSettingArrayValue('contact',$settingData);
                ?>
                <input type="text" value="<?php echo $temp; ?>" name="setting[contact]" id="contact" class="form-control">
            </div>
        </div>

        <?php if($this->functions->developer_setting('LocationMap')=='1'){ ?>
            <div class="form-group">
                <label class="col-sm-4 col-md-3 control-label" ><?php echo _uc($_e['Location Map Link']); ?></label>
                <div class="col-sm-8 col-md-9">
                    <?php
                    $temp = $this->getIBMSSettingArrayValue('locationMap',$settingData);
                    ?>
                    <input type="text" value="<?php echo $temp; ?>" name="setting[locationMap]" id="locationMap" class="form-control">
                </div>
            </div>
        <?php } ?>

        <div class="form-group">
            <label class="col-sm-4 col-md-3 control-label" ><?php echo _uc($_e['Twitter Name']); ?></label>
            <div class="col-sm-8 col-md-9">
                <?php
                $temp = $this->getIBMSSettingArrayValue('TwitterSite',$settingData);
                ?>
                <input type="text" value="<?php echo $temp; ?>" name="setting[TwitterSite]" id="TwitterSite" class="form-control">
            </div>
        </div>

        <div class="form-group">
            <label class="col-sm-4 col-md-3 control-label" ><?php echo _uc($_e['IBMS History Delete After ? Days']); ?></label>
            <div class="col-sm-8 col-md-9">
                <?php
                $temp = $this->getIBMSSettingArrayValue('historyDeleteAfterDays',$settingData);
                ?>
                <input type="number" min="8" value="<?php echo $temp; ?>" name="setting[historyDeleteAfterDays]" id="historyDeleteAfterDays" class="form-control">
            </div>
        </div>

        <div class="form-group">
            <label class="col-sm-4 col-md-3 control-label" ><?php echo _n($_e['TimeZone']); ?></label>
            <div class="col-sm-8 col-md-9">
                <?php
                $option = "";
                $temp2  = $this->getIBMSSettingArrayValue('TimeZone',$settingData);
                $option = $this->functions->get_timezone_options($temp2);
                ?>
                <select name="setting[TimeZone]" id="TimeZone" class="form-control">
                    <?php echo $option; ?>
                </select>
            </div>
        </div>
        ...
        /*                            $temp = $this->getIBMSSettingArrayValue('Email',$settingData);
                    ...
                    <div class="input-group">
                        <input type="url" name="setting[favicon]" value="<?php /*echo $temp; */?>'" id="favicon" class="favicon form-control" placeholder="favicon">
    ...
    public function checkOutOffer($settingData){
        ...
        foreach ($currency_data as $val) {
            ...
            $tds2 .= '<td>
                        <div class="input-group input-group-sm">
                          ...
                          <input type="text" class="form-control" value="'.$oldPrice.'" name="setting[check_out_price_limit]['.$country_id.']" >
                        </div>
                      </td> ';
        }
        ...
        $form_fields[] = array(
            'type' => 'none',
            'thisFormat' => " <br>
                        <h3 class='h3'>Check out offer show when cart reach at price</h3>
                        <table class='table table-striped table-hover'><tr>$tds</tr><tr>$tds2</tr></table> <hr>"
        );
