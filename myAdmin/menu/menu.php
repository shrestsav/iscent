...
?>
    ...
    <ul class="nav nav-tabs tabs_arrow" role="tablist" id="MenuTab">
        ...
        <li id="NewMenu"><a href="#newPage" role="tab" data-toggle="tab"><?php echo _uc($_e['Add New Menu']); ?></a></li>
    </ul>
    ...
    <div class="tab-content">
        <div class="tab-pane fade in active container-fluid" id="home">
            <h2  class="tab_heading"><?php echo _uc($_e['Website Menu']); ?></h2>
            <?php
                if(isset($_GET['type'])){
        ...
        <div class="tab-pane fade in container-fluid" id="newPage">
            <h2  class="tab_heading"><?php echo _uc($_e['Add New Menu']); ?></h2>
            <?php $menuC->menuNew();  ?>
        </div>
    </div>
...
<script>
    ...
    function deleteMenu(ths){
        ...
        if(secure_delete()){
            ...
            $.ajax({
                type: 'POST',
                url: 'menu/menu_ajax.php?page=deleteMenu',
                data: { id:id }
            }).done(function(data)
                {
                    ift =true;
    ...
    $(document).ready(function() {
        ...
        $( ".accordion,.accordion2,.accordion3" ).sortable({
            ...
            update : function () {
                ...
                $.ajax({
                    url: 'menu/menu_ajax.php?page=menuSort',
                    type: "post",
                    data: serial,
                    error: function(){
