...
define("DB_USER", "root");
define("DB_PASS", "");
define("DB_NAME","sharkspn_web"); //  using in pdo
define("DB_TYPE","mysql");

define("WEB_URL" , "sharkspeed_new/"); // no slash at end.. also update in common function
...
$cronWithTime   =  "* * * * * php -q ".$_SERVER['DOCUMENT_ROOT'].REQUEST_URI_WEB."cron/cron.php";// Every 3 minute
...
trait global_setting
{
       ...
       public $domain       = 'sharkspeed.net';  // Example.com OR imedia.com no www ibms.com Dont use sub domain
       ...
       public $defaultEmail = "sharkspeed.net";  //Only domain name ibms.com,, OR imedia.com
       public $bounceEmail  = "b@sharkspeed.net";  //Only use in cron
